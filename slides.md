...
<div style="display: flex; align-items: center; gap: 2rem; border-top: 2px solid rgba(255,255,255,0.3); padding-top: 1.25rem;">
  <img :src="$base + 'pcw-logo.svg'" style="height: 2rem;" alt="Philly Community Wireless" />
  <span style="color: rgba(255,255,255,0.35); font-size: 1.2rem;">·</span>
  <img :src="$base + 'TU_Primary_White.png'" style="height: 2.4rem;" alt="Temple University Libraries" />
</div>
...
<figure style="margin: 0;">
  <img :src="$base + 'maps/broadband.png'" style="width: 100%; max-height: 43vh; object-fit: contain; border-radius: 8px; box-shadow: 0 2px 12px rgba(18,50,72,0.13);" />
...
<figure style="margin: 0;">
  <img :src="$base + 'maps/internet.png'" style="width: 100%; max-height: 43vh; object-fit: contain; border-radius: 8px; box-shadow: 0 2px 12px rgba(18,50,72,0.13);" />
  <figcaption style="margin-top: 0.25rem; font-size: 0.75rem; color: #555; text-align: center; line-height: 1.3;">
...
<figure style="margin: 0;">
  <img :src="$base + 'maps/race.png'" style="width: 100%; max-height: 43vh; object-fit: contain; border-radius: 8px; box-shadow: 0 2px 12px rgba(18,50,72,0.13);" />
  <figcaption style="margin-top: 0.25rem; font-size: 0.75rem; color: #555; text-align: center; line-height: 1.3;">
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; align-items: end;">
  ...
  <figure style="margin: 0;">
    <img :src="$base + 'maps/IMG_6707.jpg'" style="width: 100%; height: 19vh; object-fit: cover; border-radius: 7px; box-shadow: 0 2px 12px rgba(18,50,72,0.13);" />
  ...
  <figure style="margin: 0;">
    <img :src="$base + 'maps/fcc_broadband.png'" style="width: 100%; height: 19vh; object-fit: contain; border-radius: 7px; box-shadow: 0 2px 12px rgba(18,50,72,0.13);" />
  ...
  <figure style="margin: 0;">
    <img :src="$base + 'maps/mapillary_traces.png'" style="width: 100%; height: 19vh; object-fit: contain; border-radius: 7px; box-shadow: 0 2px 12px rgba(18,50,72,0.13);" />
  ...
  <figure style="margin: 0;">
    <img :src="$base + 'maps/public_wifi.png'" style="width: 100%; height: 19vh; object-fit: contain; border-radius: 7px; box-shadow: 0 2px 12px rgba(18,50,72,0.13);" />
...
<img v-click :src="$base + 'maps/grant.jpg'" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 10;" />
</div>
...
<div style="display: grid; grid-template-columns: 2fr 3fr; grid-template-rows: 3fr 2fr; gap: 0.65rem; margin-top: 0.65rem; height: 54vh; overflow: hidden;">
  ...
  <img :src="$base + 'maps/capture.jpg'" style="grid-row: 1 / 3; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 14px rgba(18,50,72,0.15);" />

  <img :src="$base + 'maps/wide.png'" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 14px rgba(18,50,72,0.15);" />
...
<div style="display: flex; flex-direction: row; gap: 2rem; margin-top: 0.4rem; align-items: flex-start;">
  ...
  <img :src="$base + 'maps/signal.gif'" style="max-height: 46vh; width: auto; border-radius: 8px; box-shadow: 0 2px 14px rgba(18,50,72,0.12); flex-shrink: 0;" />
...
<div style="position: relative; width: 100%;">
  <img :src="$base + 'maps/one.jpeg'"   style="width: 100%; height: auto; display: block; border-radius: 6px; box-shadow: 0 2px 10px rgba(18,50,72,0.13);" />
  <img v-click :src="$base + 'maps/two.jpeg'"   style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: contain; border-radius: 6px;" />
  <img v-click :src="$base + 'maps/three.jpeg'" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: contain; border-radius: 6px;" />
  <img v-click :src="$base + 'maps/four.jpeg'"  style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: contain; border-radius: 6px;" />
  <img v-click :src="$base + 'maps/five.jpeg'" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: contain; border-radius: 6px;" />
</div>
...
<div style="display: grid; grid-template-columns: 1fr 1.6fr; gap: 0.5rem; height: 54vh;">
  <img :src="$base + 'maps/pole1.jpg'"    style="width: 100%; height: 100%; object-fit: cover; border-radius: 7px; box-shadow: 0 2px 10px rgba(18,50,72,0.13);" />
  <img :src="$base + 'maps/pole2.jpg'" style="width: 100%; height: 100%; object-fit: cover; border-radius: 7px; box-shadow: 0 2px 10px rgba(18,50,72,0.13);" />
</div>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.6rem;">
  ...
  <figure style="margin: 0;">
    <img :src="$base + 'maps/old_all.png'" style="width: 100%; height: auto; border-radius: 7px; box-shadow: 0 2px 10px rgba(18,50,72,0.13);" />
  ...
  <figure style="margin: 0;">
    <img :src="$base + 'maps/current_all.png'" style="width: 100%; height: auto; border-radius: 7px; box-shadow: 0 2px 10px rgba(18,50,72,0.13);" />
  ...
  <img :src="$base + 'maps/park.png'" style="grid-column: 1 / -1; width: 100%; height: 16vh; object-fit: cover; object-position: center; border-radius: 7px; box-shadow: 0 2px 10px rgba(18,50,72,0.13);" />
...
<div v-click style="position: absolute; inset: 0; display: flex; flex-direction: row; gap: 0.5rem; z-index: 10; background: #f9f7f4; border-radius: 8px; padding: 0.25rem;">
  <img :src="$base + 'maps/parcelas.png'" style="flex: 1.4; min-width: 0; object-fit: cover; border-radius: 6px;" />
  <img :src="$base + 'maps/parcelas2.jpg'" style="flex: 1; min-width: 0; object-fit: cover; border-radius: 6px;" />
</div>
</div>
...
<img :src="$base + 'maps/lessons.jpg'" style="width: 100%; height: 54vh; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 10px rgba(18,50,72,0.13);" />

</div>
<div v-click style="position: absolute; inset: 0; display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; z-index: 10;">
  <img :src="$base + 'maps/monitor.jpg'" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;" />
  <img :src="$base + 'maps/purple.png'" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;" />
</div>
</div>
...
<img :src="$base + 'maps/close.jpg'" style="width: 100%; aspect-ratio: 1 / 1; border-radius: 8px; box-shadow: 0 2px 10px rgba(18,50,72,0.13); object-fit: cover;" />
...
<img :src="$base + 'maps/end.jpg'" style="width: 100%; height: 28vh; object-fit: cover; object-position: center 40%; border-radius: 10px; margin-bottom: 1.75rem; box-shadow: 0 2px 16px rgba(18,50,72,0.18);" />
...
<div style="display: flex; flex-direction: column; gap: 0.5rem;">
  <img :src="$base + 'maps/pcw.png'" style="height: 4rem; object-fit: contain; object-position: left;" />
...
<div style="display: flex; flex-direction: column; gap: 0.5rem;">
  <img :src="$base + 'maps/Libraries_Red_Black.png'" style="height: 4rem; object-fit: contain; object-position: left;" />
  <div style="font-size: 0.82rem; color: #555; line-height: 1.7;">
